...
CREATE TABLE IF NOT EXISTS contribuintes (
    ...
    classificacao_tributos VARCHAR(10) DEFAULT '99',
    ie VARCHAR(20),
    ...
    ind_escrituracao TINYINT NOT NULL DEFAULT 0,
    ind_desoneracao TINYINT NOT NULL DEFAULT 0,
    ind_acordo_isen_multa TINYINT NOT NULL DEFAULT 0,
    ind_sit_pj TINYINT NOT NULL DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS r4020 (
    ...
    valor_base_ir DECIMAL(15,2) DEFAULT 0.00,
    valor_base_csll DECIMAL(15,2) DEFAULT 0.00,
    valor_base_cofins DECIMAL(15,2) DEFAULT 0.00,
    valor_base_pis DECIMAL(15,2) DEFAULT 0.00,
    valor_base_agreg DECIMAL(15,2) DEFAULT 0.00,
    ...
    cnpj_origem_recurso VARCHAR(14) NULL,
    observacoes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (competencia_id) REFERENCES competencias(id) ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS arquivos_gerados (
    ...
    nr_recibo_retornado VARCHAR(50) NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (competencia_id) REFERENCES competencias(id) ON DELETE CASCADE,
    FOREIGN KEY (usuario_id) REFERENCES usuarios(id) ON DELETE CASCADE
) ENGINE=InnoDB;
