            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="descricao" class="form-control" rows="2"
                              placeholder="Detalhes sobre o objeto do processo, decisão, etc."><?= htmlspecialchars($processo['descricao'] ?? '') ?></textarea>
                </div>
            </div>
