    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <?php else: foreach ($contribuintes as $c): ?>
                <tr>
                    <td class="font-monospace small"><?= htmlspecialchars($c['cnpj']) ?></td>
                    <td><?= htmlspecialchars($c['razao_social']) ?></td>
                    <td class="text-muted"><?= htmlspecialchars($c['nome_fantasia'] ?? '-') ?></td>
                    <td>
                        <?php $tipos = ['1'=>'CNPJ','2'=>'CPF','3'=>'CAEPF','4'=>'CNO'];?>
