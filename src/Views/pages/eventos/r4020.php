...
<div class="row g-3">
    <div class="col-lg-5">
        <div class="card">
            <div class="card-header">Adicionar Pagamento PJ</div>
            <div class="card-body p-4">
                <form action="/eventos/r4020/salvar" method="POST">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="cnpj_beneficiario" class="form-control font-monospace" data-mask="cnpj" required placeholder="00.000.000/0001-00">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Razão Social</label>
                        <input type="text" name="razao_social_beneficiario" class="form-control" placeholder="Nome da empresa">
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" name="valor_csll" class="form-control text-end" placeholder="0,00">
                        </div>
                        <div class="col-3">
                            <label class="form-label">COFINS</label>
                            <input type="text" name="valor_cofins" class="form-control text-end" placeholder="0,00">
                        </div>
                        <div class="col-3">
                            <label class="form-label">PIS</label>
                            <input type="text" name="valor_pis" class="form-control text-end" placeholder="0,00">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    <thead>
                        <tr>
                            <th>CNPJ</th><th>Beneficiário</th><th>Data</th>
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="8" class="text-center text-muted py-4">Nenhum registro. Adicione pagamentos PJ com retenção.</td></tr>
                    ...
                    <tfoot class="table-light fw-bold">
                        <tr>
                            ...
                            <td class="text-end small">R$ <?= number_format(array_sum(array_column($registros, 'valor_pis')) + array_sum(array_column($registros, 'valor_cofins')), 2, ',', '.') ?></td>
                            <td></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?>
