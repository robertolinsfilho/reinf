                ...
                <form action="/importar/processar" method="POST" enctype="multipart/form-data" id="form-importar">
                    ...
                    <div class="mb-3 d-none" id="bloco-auto">
                        ...
                        <select name="contribuinte_id" id="contribuinte_id" class="form-select">
                            ...
                            @foreach($contribuintes as $ct)
                            <option value="{{ (int) $ct['id'] }}">
                                {{ $ct['razao_social'] }} — {{ $ct['cnpj'] }}
                            </option>
                            @endforeach
                        </select>
                ...
                <table class="table table-sm table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="small" title="{{ $h['arquivo_nome'] ?? '' }}">
                                {{ mb_strimwidth($h['arquivo_nome'] ?? '—', 0, 25, '…') }}
                            </td>
                            <td class="small">
                            ...
                            <td>
                                ...
                                @elseif($h['status'] === 'erro')
                                    <span class="badge bg-danger" title="{{ $h['log_erros'] ?? '' }}"><i class="bi bi-x-lg"></i></span>
                                @else
